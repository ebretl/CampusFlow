...
- (void)drawInContext:(CGContextRef)context
{
    ...
    NSInteger int_progress = (int)roundf(self.progress * (self.total - self.min) + self.min);
...
- (void)setProgress:(CGFloat)progress animated:(BOOL)animated
{
    ...
    [self.progressLayer setTotal:total];
    [self.progressLayer setMin:min];
